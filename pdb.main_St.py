...
if __name__ == '__main__':
    ...
    ##--- read ht from file ---
    d1.L_all_ht = np.loadtxt('./ht3.dat', dtype=int)
    ...
    ##--- St ---
    time_col, St_col = d1.St( 10, 500 )
    np.savetxt(    fn_prefix+'St3050.dat', np.transpose( [time_col, St_col] ), fmt=['%d', '%f'], header='time/ps, St'      )
    ##--- timer stop ---
