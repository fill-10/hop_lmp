...
def unwrap(atom_group, box ):
    atom_group['xu'] = atom_group['x'] + atom_group['ix'] * (box[0][1]-box[0][0] )
    atom_group['yu'] = atom_group['y'] + atom_group['iy'] * (box[1][1]-box[1][0] )
    atom_group['zu'] = atom_group['z'] + atom_group['iz'] * (box[2][1]-box[2][0] )
